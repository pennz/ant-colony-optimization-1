...
class TestAntColonyIntegrationTesting(unittest.TestCase):
    ...
    def test_random_walk_8(self):
        ...
        test_object = module.AntColony(mapping, distance_on_earth, iterations=100)
        # ... as the longititue and xxx cooridination points
        #print("9->2", test_object.distance_callback(test_object.nodes[9],test_object.nodes[2]),
        #      "9->8", test_object.distance_callback(test_object.nodes[9],test_object.nodes[8]))
        # 9->2 3405.875846932117 9->8 3345.62514657828
        solution = test_object.mainloop()
        #_DEBUG(solution)
        self.assertEqual(test_solution, solution)
